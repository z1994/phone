    ...
    var r = "",
        ...
        i = {
            init: function (a) {
                ...
                if (a.when)
                    for (e in a.when) j(e, a.when) && this.bind(e, a.when[e]);
                this.css({
                    position: "relative",
                    width: a.width,
                    height: a.height
            ...
            _turnPage: function (a, b) {
                ...
                if (e.page != a) {
                    ...
                    this.trigger(w, [a, l]);
                    if (w.isDefaultPrevented()) return; - 1 != f.inArray(1, l) && this.trigger("first"); - 1 != f.inArray(e.totalPages, l) && this.trigger("last")
                }
            ...
            update: function () {
                ...
                if (b.pageMv.length && 0 !== b.pageMv[0]) {
                    ...
                    for (a in b.pageWrap) j(a, b.pageWrap) && (d = i._setPageLoc.call(this, a), b.pages[a] && b.pages[a].flip("disable", b.disabled || 1 != d).flip("z", null))
            },
            ...
            options: function (a) {
                ...
                if (a.when)
                    for (var c in a.when) j(c, a.when) && this.unbind(c).bind(c, a.when[c]);
                return this
            },
            version: function () {
                return "4.1.0"
